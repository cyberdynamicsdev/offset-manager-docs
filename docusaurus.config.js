...
const config = {
  ...
  tagline: "Offset Manager - Documentation",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://docs.offsetmanager.com",
  ...
  organizationName: "cyberdynamicsdev", // Usually your GitHub org/user name.
  projectName: "offset-manager-docs", // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Offset Manager`,
      },
      prism: {
